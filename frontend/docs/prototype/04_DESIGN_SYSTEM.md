...
## 1. Design Philosophy
Desain antarmuka SIGMA-K mengadopsi standar aplikasi pemerintahan Republik Indonesia modern (*Indonesian Enterprise e-Gov Design System*):
...
- **Accessible (WCAG 2.1 AA):** Rasio kontras teks terhadap latar belakang dipertahankan di atas 4.5:1 untuk menjamin keterbacaan optimal pada layar perkantoran pemerintah.
